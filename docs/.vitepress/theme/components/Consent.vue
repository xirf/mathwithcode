...
const i18n = {
  'id-ID': {
    consent: 'Situs ini sedang dalam pengembangan. Materi mungkin belum lengkap dan membutuhkan peninjauan lebih lanjut.',
    button: 'Okei'
  },
  'en-US': {
    consent: 'This site is currently under development. Material may be incomplete and require further review.',
    button: 'Okay'
  }
}
